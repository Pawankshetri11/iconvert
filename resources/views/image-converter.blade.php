...
@section('styles')
    ...
    <style>
        ...
        /* Image Converter specific overrides */
        ...
        <div class="max-w-[95%] mx-auto">
            ...
            <div class="text-center mb-16" data-aos="fade-down">
                <h1 class="text-4xl md:text-6xl font-display font-bold text-white mb-4">
                    ...
                    <span class="text-gold-gradient">Master Your Images</span>
                </h1>
                <p class="text-zinc-400 max-w-2xl mx-auto text-lg font-light">
                    Convert, compress, resize, crop and edit images with just a few clicks.
                </p>
            </div>
            ...
            <div class="mb-16">
                <div class="section-divider" data-aos="fade-right">
                    <h2 class="text-[#ffd700] font-bold tracking-widest text-sm uppercase">Convert Images</h2>
                </div>

                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <!-- JPG to PNG -->
                    <a href="{{ route('image-editor', 'convert') }}" class="glass-panel rounded-xl p-6 group cursor-pointer block" data-tilt>
                        ...
                        <p class="text-xs text-zinc-400">Convert between JPG, PNG, WEBP, and more formats.</p>
                    </a>

                    <!-- Compress -->
                    <a href="{{ route('image-editor', 'compress') }}" class="glass-panel rounded-xl p-6 group cursor-pointer block" data-tilt>
                        ...
                        <h3 class="text-lg font-bold text-white mb-2">Compress Images</h3>
                        <p class="text-xs text-zinc-400">Reduce file size while maintaining quality.</p>
                    </a>

                    <!-- Resize -->
                    <a href="{{ route('image-editor', 'resize') }}" class="glass-panel rounded-xl p-6 group cursor-pointer block" data-tilt>
                        <div class="w-12 h-12 rounded-lg bg-purple-500/10 flex items-center justify-center mb-4 group-hover:bg-purple-500/20 transition-colors">
                            <i data-lucide="expand" class="w-6 h-6 text-purple-400"></i>
                        </div>
                        <h3 class="text-lg font-bold text-white mb-2">Resize Images</h3>
                        <p class="text-xs text-zinc-400">Change dimensions and aspect ratios.</p>
                    </a>

                    <!-- Crop -->
                    <a href="{{ route('image-editor', 'crop') }}" class="glass-panel rounded-xl p-6 group cursor-pointer block" data-tilt>
                        <div class="w-12 h-12 rounded-lg bg-orange-500/10 flex items-center justify-center mb-4 group-hover:bg-orange-500/20 transition-colors">
                            <i data-lucide="crop" class="w-6 h-6 text-orange-400"></i>
                        </div>
                        <h3 class="text-lg font-bold text-white mb-2">Crop Images</h3>
                        <p class="text-xs text-zinc-400">Remove unwanted parts and focus on subjects.</p>
                    </a>
                </div>
            </div>
            ...
            <div class="mb-16">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <!-- Rotate -->
                    <a href="{{ route('image-editor', 'edit') }}" class="glass-panel rounded-xl p-6 group cursor-pointer block" data-tilt>
                        <div class="w-12 h-12 rounded-lg bg-red-500/10 flex items-center justify-center mb-4 group-hover:bg-red-500/20 transition-colors">
                            <i data-lucide="rotate-cw" class="w-6 h-6 text-red-400"></i>
                        </div>
                        <h3 class="text-lg font-bold text-white mb-2">Rotate & Flip</h3>
                        <p class="text-xs text-zinc-400">Rotate images and flip horizontally/vertically.</p>
                    </a>
                    ...
                    <a href="{{ route('image-editor', 'edit') }}" class="glass-panel rounded-xl p-6 group cursor-pointer block" data-tilt>
                        ...
                        <h3 class="text-lg font-bold text-white mb-2">Apply Filters</h3>
                        <p class="text-xs text-zinc-400">Enhance with brightness, contrast, saturation.</p>
                    </a>
                    ...
                    <a href="{{ route('image-editor', 'edit') }}" class="glass-panel rounded-xl p-6 group cursor-pointer block" data-tilt>
                        <div class="w-12 h-12 rounded-lg bg-cyan-500/10 flex items-center justify-center mb-4 group-hover:bg-cyan-500/20 transition-colors">
                            <i data-lucide="stamp" class="w-6 h-6 text-cyan-400"></i>
                        </div>
                        <h3 class="text-lg font-bold text-white mb-2">Add Watermark</h3>
                        <p class="text-xs text-zinc-400">Protect your images with text or logo watermarks.</p>
                    </a>

                    <!-- Advanced Editor -->
                    <a href="{{ route('image-editor', 'edit') }}" class="glass-panel rounded-xl p-6 group cursor-pointer border-[#ffd700]/20 block" data-tilt>
                        <div class="w-12 h-12 rounded-lg bg-[#ffd700]/10 flex items-center justify-center mb-4">
                            <i data-lucide="pen-tool" class="w-6 h-6 text-[#ffd700]"></i>
                        </div>
                        <h3 class="text-lg font-bold text-white mb-2">Advanced Editor</h3>
                        <p class="text-xs text-zinc-400">Full-featured image editing with shapes and text.</p>
                    </a>
                </div>
            </div>
