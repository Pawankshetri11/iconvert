...
@section('styles')
    ...
    <style>
        ...
        /* ID Card Creator specific overrides */
        ...
        <div class="max-w-[95%] mx-auto">
            ...
            <div class="text-center mb-16" data-aos="fade-down">
                <h1 class="text-4xl md:text-6xl font-display font-bold text-white mb-4">
                    Professional ID Card <br>
                    <span class="text-gold-gradient">Creator Suite</span>
                </h1>
                <p class="text-zinc-400 max-w-2xl mx-auto text-lg font-light">
                    Create professional ID cards with QR codes, photos, and customizable templates for any organization.
                </p>
            </div>
            ...
            <div class="mb-16">
                <div class="section-divider" data-aos="fade-right">
                    <h2 class="text-[#ffd700] font-bold tracking-widest text-sm uppercase">ID Card Types</h2>
                </div>

                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <!-- Employee ID -->
                    <a href="{{ route('id-card-editor', 'employee') }}" class="glass-panel rounded-xl p-6 group cursor-pointer block" data-tilt>
                        ...
                        <h3 class="text-lg font-bold text-white mb-2">Employee ID</h3>
                        <p class="text-xs text-zinc-400">Professional employee identification cards.</p>
                    </a>

                    <!-- Student ID -->
                    <a href="{{ route('id-card-editor', 'student') }}" class="glass-panel rounded-xl p-6 group cursor-pointer block" data-tilt>
                        ...
                        <h3 class="text-lg font-bold text-white mb-2">Student ID</h3>
                        <p class="text-xs text-zinc-400">Educational institution ID cards.</p>
                    </a>

                    <!-- Visitor Badge -->
                    <a href="{{ route('id-card-editor', 'visitor') }}" class="glass-panel rounded-xl p-6 group cursor-pointer block" data-tilt>
                        ...
                        <h3 class="text-lg font-bold text-white mb-2">Visitor Badge</h3>
                        <p class="text-xs text-zinc-400">Temporary visitor identification.</p>
                    </a>

                    <!-- Member Card -->
                    <a href="{{ route('id-card-editor', 'member') }}" class="glass-panel rounded-xl p-6 group cursor-pointer block" data-tilt>
                        ...
                        <h3 class="text-lg font-bold text-white mb-2">Member Card</h3>
                        <p class="text-xs text-zinc-400">Club or organization membership cards.</p>
                    </a>
                </div>
            </div>
            ...
            <div class="mb-16">
                <div class="section-divider" data-aos="fade-right">
                    <h2 class="text-[#ffd700] font-bold tracking-widest text-sm uppercase">Templates & Styles</h2>
                </div>

                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <!-- Corporate -->
                    <a href="{{ route('id-card-editor', 'corporate') }}" class="glass-panel rounded-xl p-6 group cursor-pointer block" data-tilt>
                        <div class="w-12 h-12 rounded-lg bg-red-500/10 flex items-center justify-center mb-4 group-hover:bg-red-500/20 transition-colors">
                            <i data-lucide="building" class="w-6 h-6 text-red-400"></i>
                        </div>
                        <h3 class="text-lg font-bold text-white mb-2">Corporate</h3>
                        <p class="text-xs text-zinc-400">Professional business ID card templates.</p>
                    </a>

                    <!-- Security -->
                    <a href="{{ route('id-card-editor', 'security') }}" class="glass-panel rounded-xl p-6 group cursor-pointer block" data-tilt>
                        ...
                        <p class="text-xs text-zinc-400">High-security ID cards with holograms.</p>
                    </a>

                    <!-- Modern -->
                    <a href="{{ route('id-card-editor', 'modern') }}" class="glass-panel rounded-xl p-6 group cursor-pointer block" data-tilt>
                        ...
                        <p class="text-xs text-zinc-400">Contemporary designs with clean layouts.</p>
                    </a>

                    <!-- Custom -->
                    <a href="{{ route('id-card-editor', 'custom') }}" class="glass-panel rounded-xl p-6 group cursor-pointer block" data-tilt>
                        <div class="w-12 h-12 rounded-lg bg-pink-500/10 flex items-center justify-center mb-4 group-hover:bg-pink-500/20 transition-colors">
                            <i data-lucide="palette" class="w-6 h-6 text-pink-400"></i>
                        </div>
                        <h3 class="text-lg font-bold text-white mb-2">Custom Design</h3>
                        <p class="text-xs text-zinc-400">Fully customizable ID card creator.</p>
                    </a>
                </div>
            </div>
