        ...
        <div class="glass-card rounded-2xl overflow-hidden">
            ...
            <div class="px-6 mb-5">
                <div class="bg-black/30 p-1 rounded-lg flex relative border border-white/5">
                    <div id="glider" class="tab-glider absolute top-1 bottom-1 right-1 w-[calc(50%-4px)] bg-zinc-800 rounded shadow-sm border border-white/10"></div>
                    <button id="btn-login" class="flex-1 z-10 py-1.5 text-xs font-medium text-zinc-500 transition-colors">Log In</button>
                    <button id="btn-signup" class="flex-1 z-10 py-1.5 text-xs font-medium text-white transition-colors">Sign Up</button>
                </div>
            </div>
            ...
            <div id="container" class="forms-container px-6 pb-6 min-h-[300px]">
                ...
                <!-- LOGIN -->
                <form id="login" class="form-slide flex flex-col gap-3" method="POST" action="{{ route('login') }}">
                    @csrf
                ...
                <!-- SIGNUP -->
                <form id="signup" class="form-slide active flex flex-col gap-3" method="POST" action="{{ route('register') }}">
                    @csrf
                    <div class="input-wrapper">
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="Full Name" class="input-field w-full pl-9 pr-3 py-2.5 rounded-lg text-sm bg-transparent text-white placeholder-zinc-600 focus:outline-none" required autofocus>
