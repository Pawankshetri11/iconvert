                ...
                <div class="relative bg-gray-800 rounded-2xl p-8 border-2 {{ $plan->is_popular ? 'border-yellow-500' : 'border-gray-700' }} hover:border-yellow-400 transition-all duration-300 transform hover:scale-105">
                    ...
                    <div class="text-center mb-8">
                        ...
                        @if($plan->billing_cycle === 'yearly' && $plan->price > 0)
                            <p class="text-green-400 text-sm mt-1">Save with yearly billing</p>
                        @endif
                    </div>
        ...
        <div class="mt-20 max-w-4xl mx-auto">
            ...
            <div class="space-y-6">
                <div class="bg-gray-800 rounded-lg p-6">
                    <h3 class="text-xl font-semibold text-white mb-2">Can I change my plan anytime?</h3>
                    <p class="text-gray-300">Yes, you can upgrade or downgrade your plan at any time. Changes take effect immediately.</p>
                </div>
                <div class="bg-gray-800 rounded-lg p-6">
                    <h3 class="text-xl font-semibold text-white mb-2">What happens to my files?</h3>
                    <p class="text-gray-300">Your converted files are available for download immediately and stored temporarily for your convenience.</p>
                </div>
                <div class="bg-gray-800 rounded-lg p-6">
                    <h3 class="text-xl font-semibold text-white mb-2">Is there a free trial?</h3>
                    <p class="text-gray-300">Yes! Sign up for any paid plan and get 3 free conversions to try our service.</p>
                </div>
            </div>
        </div>
    </div>
